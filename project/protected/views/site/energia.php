      <section class="background-image">
        <article>
          <div class="image-background"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/banner/Banner_energia.png"/></div>
        </article>
      </section>
          ...
          ?>
            <div class="col-md-6 col-sm-6 col-xs-12 row <?php echo $color; ?>-item">
              ...
              <?php foreach ($postsInside as $key => $postInside) { ?>
                <a href="<?php echo $this->createUrl('/energia/'.$postInside->post__url); ?>" class="row between-xs around-xs middle-xs rectangle-<?php echo $color; ?>">
