					            ...
					            <?php
					            	foreach ($news as $key => $new) { ?>
										<tr>
											...
											<td><div class="img-circl img-table-rep" style="background-image:url(<?php echo Yii::app()->request->baseUrl; ?>/images/<?php echo ($new->imagen != '')?('news/300x300/'.$new->imagen):'admin/gray.jpg'; ?>)"></div></td>
